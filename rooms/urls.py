...
urlpatterns = [
    ...
    # Visit Request URLs
    path(
        "visit-request/", CreateVisitRequestView.as_view(), name="create_visit_request"
    ),
    path(
        "visit-request/confirm/<int:visit_request_id>/",
        ConfirmVisitRequestView.as_view(),
        name="confirm_visit_request",
    ),
    path(
        "visit-request/cancel/<int:visit_request_id>/",
        CancelVisitRequestView.as_view(),
        name="cancel_visit_request",
    ),
    # Notification URLs
    ...
    path(
        "roomsview/<int:room_id>/comments/",
        RoomCommentAPIView.as_view(),
        name="room-comments",
    ),
    path(
        "roomsview/<int:room_id>/identity/",
        IdentityVerificationAPIView.as_view(),
        name="room-identity",
    ),
]
